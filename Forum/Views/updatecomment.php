...
require 'config.php';
$idc=$_GET['id'];
$sql='SELECT * FROM comment WHERE id:=idc';
...
if (isset ($_POST['name']) ) 
{
  ...
  $sql = 'UPDATE comment SET com=:comment WHERE id_c=:idc';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':comment' => $comment, ':idc' => $idc])) 
    {
      ...
      <div class="card-body">
        ...
        <form method="post">
          <div class="form-group">
            ...
            <input type="text"  name="name" id="name" class="form-control" placehoder="Edit your comment">
          </div>
